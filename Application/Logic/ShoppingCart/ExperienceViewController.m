...
//    cart_type:购物车的类别。0:在线购物车，1:到店体验车
    ...
    [dataDict setObject:@"1" forKey:@"cart_type"];
                             ...
                             andBlock:^(NSString*requestStr) {
                                 ...
                                 if ([requestStr isEqualToString:@"Start"]) {
                                     ...
                                     if (backDic != nil) {
                                         ...
                                         [btnComment setTitle:@"确定体验" forState:UIControlStateNormal];
                                         btnComment.alpha = 0.5;
                                        // [btnComment setTitle:[NSString stringWithFormat:@"确定体验(%d)", backDataArr.count] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *CellIdentifier = @"ExperienceCartCell";
    ...
    if (cell == nil) {
        ...
        cell = [[[NSBundle mainBundle] loadNibNamed:@"ExperienceCartCell" owner:self options:nil] lastObject];
    }
    ...
    UILabel *addTime = (UILabel *)[cell viewWithTag:12];
    ...
    addTime.text = [backDataArr[indexPath.row] valueForKey:@"add_to_cart_datetime"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (selCount > 0) {
        ...
        [btnComment setTitle:[NSString stringWithFormat:@"确定体验(%d)", selCount] forState:UIControlStateNormal];
...
forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [self deleteExperience:indexPath.row];
