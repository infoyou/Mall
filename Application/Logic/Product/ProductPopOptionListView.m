...
@interface ProductPopOptionListView (private)
...
@implementation ProductPopOptionListView
@synthesize delegate;
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetShadowWithColor(ctx, CGSizeMake(0, 1), 0.5f, [UIColor colorWithHexString:@"0xf86052"].CGColor);
